...
public class FilterAndMap {
    public static void main(String[] args) {
       ...
       // list.stream().forEach(e->System.err.println(e));
        ...
        // Filter method take predicate as input,it return boolean that is true or false.
        ...
        // Map method take consumer (consume input as element) and it return element value that is processed.
        ...
        list1.stream().forEach(System.out::println);  // here println is referenece associated with double colon(::) operator
